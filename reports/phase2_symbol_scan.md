...
| 2 | 3 | 2000 | 20 | 5 | ByWeight(keys_excluding_0=[]) | `(* (+ y z) x)` |
| 3 | 3 | 2000 | 100 | 5 | ByWeight(keys_excluding_0=[]) | `(* (+ y z) x)` |
...
| 2 | 3 | 2000 | 20 | 4 | ByWeight(keys_excluding_0=[]) | `(+ x y z)` |
| 3 | 3 | 2000 | 100 | 4 | ByWeight(keys_excluding_0=[]) | `(+ x y z)` |
...
| 2 | 3 | 2000 | 20 | 2 | ByWeight(keys_excluding_0=[2]) | `(li2 x)` |
| 3 | 3 | 2000 | 100 | 2 | ByWeight(keys_excluding_0=[2]) | `(li2 x)` |
...
| 2 | 3 | 2000 | 20 | 5 | ByWeight(keys_excluding_0=[2]) | `(* (log x) (log y))` |
| 3 | 3 | 2000 | 100 | 5 | ByWeight(keys_excluding_0=[2]) | `(* (log x) (log y))` |
